# 💻 Portfólio de Projetos — Gabriel

> Desenvolvedor Full Stack com experiência em aplicações desktop, web e mobile — com foco em automação, análise de dados e integração com hardware.
...
Integração direta com PostgreSQL e automação de fluxos ETL, otimizando a análise de performance e resultados.
...
- Suporte multilíngue e relógio interno do sistema  

💡 Projeto desenvolvido para máquinas de autoatendimento financeiras.
...
Sou apaixonado por **criar soluções completas**, do back-end à interface, unindo **dados, automação e design funcional**.  
Atualmente desenvolvo aplicações sob demanda para empresas e instituições, com foco em eficiência e experiência do usuário.
...
📱 **WhatsApp:** [whatsapp.com/gabriel.baptista](https://api.whatsapp.com/send?phone=41997526613)  
